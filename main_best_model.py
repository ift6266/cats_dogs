...
algorithm = GradientDescent(cost=cost, parameters=cg.parameters, step_rule=Adam(learning_rate=0.0005))
extensions = [Timing(),
...
extensions.append(Plot('CatsVsDogs_256', channels=[['train_error_rate', 'valid_error_rate'],['valid_cost', 'valid_error_rate2'],['train_total_gradient_norm']],after_epoch=True))
